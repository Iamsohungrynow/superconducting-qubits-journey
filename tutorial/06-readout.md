...
4. **Transmon $\chi$:** $\chi = (-5)\cdot\dfrac{-300}{-2000-300} = (-5)(0.130) = -0.65$ MHz. So $2|\chi|/2\pi \approx 1.3$ MHz vs $\kappa/2\pi = 2$ MHz, near the $2|\chi|\sim\kappa$ design scale.
...
6. **Measurement dephasing** at $\bar n=5$: $\Gamma_\phi = 8\chi^2\bar n/\kappa \approx 2\pi\cdot8.5$ MHz, so coherence is gone in ~19 ns. Fine: we've already collapsed to a $Z$ eigenstate; readout and idle coherence are different regimes.
